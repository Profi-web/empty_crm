$(document).ready(function () {
    ...
    $('.delete_supplier').on('click',function () {
        var id = $(this).attr('id');
        alertify.confirm('Verwijderen',"Weet je zeker dat je dit supplier wilt verwijderen?",
            function(){
                $.ajax({ //Process the form using $.ajax()
                    type: 'POST', //Method type
                    url: '/controllers/tables/supplier/supplier_delete.php', //Your form processing file URL
