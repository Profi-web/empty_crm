$(document).ready(function () {
    ...
    $('.delete_procedures').on('click',function () {
        var id = $(this).attr('id');
        alertify.confirm('Verwijderen',"Weet je zeker dat je deze procedure wilt verwijderen?",
            function(){
                $.ajax({ //Process the form using $.ajax()
                    type: 'POST', //Method type
                    url: '/controllers/tables/procedure/procedures_delete.php', //Your form processing file URL
