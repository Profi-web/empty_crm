$(document).ready(function () {
    ...
    $('.delete_order').on('click',function () {
        var id = $(this).attr('id');
        alertify.confirm('Verwijderen',"Weet je zeker dat je deze bestelling wilt verwijderen?",
            function(){
                $.ajax({ //Process the form using $.ajax()
                    type: 'POST', //Method type
                    url: '/controllers/tables/orders/orders_delete.php', //Your form processing file URL
