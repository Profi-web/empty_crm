...
/*Classes*/
$user = new User();
$table = new Table($pagination,'suppliers',$page);
//
        ...
        <div class="card shadow col-12 p-0">
            <div class="card-header border-0 bg-white rounded-top p-4">
                <div class="row px-4 align-items-center justify-content-between">
                    <h5 class="mb-0 ">Alle leveranciers</h5>
                    <a class="btn btn-info rounded text-white" href="/leveranciers/nieuw">Nieuwe leverancier</a>
                </div>
            </div>
            <div class="table-responsive">
                <table class="table align-items-center table-flush mb-0 table-hover">
                    ...
                    <tbody class="suppliers_table" id="<?php echo $table->currentpage; ?>">
                    </tbody>
                </table>
            </div>
